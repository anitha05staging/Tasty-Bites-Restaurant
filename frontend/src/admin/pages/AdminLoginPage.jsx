            ...
            >
                <div className="bg-white rounded-[3rem] shadow-2xl shadow-admin-secondary/10 overflow-hidden border border-gray-100">
                    <div className="p-10">
                            ...
                            <p className="text-gray-500 font-medium font-poppins text-sm italic">Login</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-4 font-poppins">Email</label>
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center ml-4">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 font-poppins">Password</label>
                                </div>
                                <div className="relative group">
